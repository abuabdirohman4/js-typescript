...
// type inference
let list3 = ['hello', 2, 3, 4];
// square bracket
let list3_2: (number | string)[];
list3_2 = ['hello', 2, 3, 4];
// generic array
let list3_3: Array<number | string>;
list3_3 = ['hello', 2, 3, 4];
...
// tidak bisa pakai type inference

// Pakainya squeare bracket
...
// generic array
let matrix_2: Array<Array<number>>;
matrix_2 = [
    [1, 2],
    [3, 4],
];
